...
(cl:defclass <console_controller> (roslisp-msg-protocol:ros-message)
  ((B
    :reader B
    :initarg :B
    :type cl:boolean
...
(cl:defclass console_controller (<console_controller>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <console_controller>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'console_controller)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name umnitsa_rpi-msg:<console_controller> is deprecated: use umnitsa_rpi-msg:console_controller instead.")))

(cl:ensure-generic-function 'B-val :lambda-list '(m))
(cl:defmethod B-val ((m <console_controller>))
...
(cl:defmethod A-val ((m <console_controller>))
...
(cl:defmethod Y-val ((m <console_controller>))
...
(cl:defmethod X-val ((m <console_controller>))
...
(cl:defmethod L-val ((m <console_controller>))
...
(cl:defmethod R-val ((m <console_controller>))
...
(cl:defmethod ZL-val ((m <console_controller>))
...
(cl:defmethod ZR-val ((m <console_controller>))
...
(cl:defmethod MINUS-val ((m <console_controller>))
...
(cl:defmethod PLUS-val ((m <console_controller>))
...
(cl:defmethod LCLICK-val ((m <console_controller>))
...
(cl:defmethod RCLICK-val ((m <console_controller>))
...
(cl:defmethod HOME-val ((m <console_controller>))
...
(cl:defmethod CAPTURE-val ((m <console_controller>))
...
(cl:defmethod UP-val ((m <console_controller>))
...
(cl:defmethod RIGHT-val ((m <console_controller>))
...
(cl:defmethod LTOGRIGHT-val ((m <console_controller>))
...
(cl:defmethod LTOGUP-val ((m <console_controller>))
...
(cl:defmethod RTOGRIGHT-val ((m <console_controller>))
...
(cl:defmethod RTOGUP-val ((m <console_controller>))
  ...
  (RTOGUP m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <console_controller>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <console_controller>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<console_controller>)))
  "Returns string type for a message object of type '<console_controller>"
  "umnitsa_rpi/console_controller")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'console_controller)))
  "Returns string type for a message object of type 'console_controller"
  "umnitsa_rpi/console_controller")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<console_controller>)))
  "Returns md5sum for a message object of type '<console_controller>"
  "eecd6f451cf88ba32eb3689bc81dee01")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'console_controller)))
  "Returns md5sum for a message object of type 'console_controller"
  "eecd6f451cf88ba32eb3689bc81dee01")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<console_controller>)))
  "Returns full string definition for message of type '<console_controller>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'console_controller)))
  "Returns full string definition for message of type 'console_controller"
  (cl:format cl:nil "bool B~%bool A~%bool Y~%bool X~%bool L~%bool R~%bool ZL~%bool ZR~%bool MINUS~%bool PLUS~%bool LCLICK~%bool RCLICK~%bool HOME~%bool CAPTURE~%bool UP~%bool RIGHT~%float32 LTOGRIGHT~%float32 LTOGUP~%float32 RTOGRIGHT~%float32 RTOGUP~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <console_controller>))
  (cl:+ 0
     1
     1
     1
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <console_controller>))
  "Converts a ROS message object to a list"
  (cl:list 'console_controller
    (cl:cons ':B (B msg))
    (cl:cons ':A (A msg))
    (cl:cons ':Y (Y msg))
    (cl:cons ':X (X msg))
